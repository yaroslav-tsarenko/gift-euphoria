    ...
    <div className="termsandconditionspage">
      ...
      <main className="lilylamb-kids-we-us-or-parent">
        ...
        <div className="definitions-parent">
          ...
          <div className="definition-items-parent">
        ...
        <div className="use-of-gift-cards-parent">
          <h1 className="use-of-gift-container">
            <ol className="use-of-gift-cards">
              <li> Use of Gift Cards</li>
            </ol>
          </h1>
          <div className="redemption-items-parent">
            <div className="redemption-items">
              <h3 className="redemption">3.1 Redemption</h3>
            ...
            <div className="redemption-items1">
              <h3 className="non-transferable">3.2 Non-Transferable</h3>
            ...
            <div className="redemption-items2">
              <h3 className="no-cash-redemption">3.3 No Cash Redemption</h3>
              <div className="gift-cards-are1">
            ...
            <div className="redemption-items3">
              <h3 className="expiration">3.4 Expiration</h3>
              <div className="gift-cards-do">
        ...
        <div className="purchase-of-gift-cards-parent">
          ...
          <div className="purchase-channels-items-parent">
            <div className="purchase-channels-items">
              <h3 className="purchasing-channels">4.1 Purchasing Channels</h3>
              <div className="gift-cards-can1">
            ...
            <div className="purchase-channels-items1">
            ...
            <div className="purchase-channels-items2">
            ...
            <div className="purchase-channels-items3">
            ...
            <div className="purchase-channels-items4">
        ...
        <div className="governing-law-group">
          ...
          <div className="jurisdiction-container-wrapper">
