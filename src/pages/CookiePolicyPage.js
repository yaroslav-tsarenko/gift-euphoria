    ...
    <div className="cookiepolicypage">
      ...
      <main className="content-wrapper">
        ...
        <div className="cookie-usage-wrapper">
          ...
          <div className="cookie-usage-details">
            <div className="cookie-usage-types">
            ...
            <div className="cookie-usage-types1">
            ...
            <div className="cookie-usage-types2">
            ...
            <div className="cookie-usage-types3">
        ...
        <div className="cookie-management-wrapper">
          ...
          <div className="cookie-management-details">
            ...
            <div className="cookie-management-options1">
            ...
            <div className="cookie-management-options2">
